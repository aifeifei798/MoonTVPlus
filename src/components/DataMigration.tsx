...
// 备份文件内容不可信（timestamp/serverVersion 均来自上传文件），插入 HTML 前必须转义
...
const AlertModal = ({
  ...
  return createPortal(
    <div
      className={`fixed inset-0 bg-black/50 z-[1000] flex items-center justify-center p-4 transition-opacity duration-200 ${
      ...
      showAlert({
        ...
        html: `
          <div class="text-left">
            ...
            <p class="mt-2">导入的用户数量: ${escapeHtml(
