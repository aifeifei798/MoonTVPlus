...
const FilterOptions: React.FC<FilterOptionsProps> = ({
  ...
  return (
    <div className='flex w-full border rounded-lg overflow-hidden shadow-xs dark:border-gray-700 flex-col'>
      {/* Tab 栏 + 排序按钮 */}
      <div className='flex items-center justify-between px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800'>
        <div className='flex gap-4'>
          <button
            className={`px-3 py-1 font-semibold rounded-sm ${
              activeTab === '筛选'
          ...
          {activeTab === '筛选' && (
            <>
              ...
              <button
                ...
                className='p-1 border rounded-sm hover:bg-gray-200 dark:hover:bg-gray-700'
              >
                {collapsed ? (
