            ...
            <form onSubmit={handleSearch} className='mb-4'>
              <div className='relative'>
                ...
                <input
                  ...
                  className='w-full h-12 pl-10 pr-20 rounded-lg bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-hidden focus:ring-2 focus:ring-green-500 focus:border-transparent'
                />
                <button
                  type='submit'
                  ...
                  <div className='flex items-start justify-between'>
                    <div className='flex-1'>
                      ...
                      <div className='flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400'>
                        <span className='px-2 py-0.5 bg-gray-100 dark:bg-gray-700 rounded-sm'>
