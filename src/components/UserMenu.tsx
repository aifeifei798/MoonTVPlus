        ...
        <div className='space-y-6'>
          ...
          <div className='flex items-center justify-between mt-2'>
            ...
            <input
              type='number'
              min='-1'
              className='w-11 px-2 py-1 rounded-sm text-sm bg-[#f5f5f5] dark:bg-gray-800 text-gray-900 dark:text-gray-100 outline-hidden border-none focus:outline-hidden focus:border-none focus:ring-0'
      ...
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white dark:bg-gray-900 rounded-xl shadow-xl z-[1001] p-6'>
        ...
        <div className='space-y-4'>
          ...
          <div>
            ...
            <input
              type='password'
              className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:outline-hidden focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400'
              placeholder='请输入新密码'
              value={newPassword}
